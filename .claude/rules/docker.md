...
- Pi Camera capture requires explicit camera device access (`ENABLE_CAMERA=true`) and camera CLI commands such as `rpicam-still`/`rpicam-vid`; keep it optional and document privacy impact.
