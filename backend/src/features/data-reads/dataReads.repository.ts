...
export function createDataSourceRead(input: { dataSourceId: string; workflowId?: string | null; sourceName: string; sourceUrl: string; triggerType: "manual" | "automation" | "webhook"; status: "success" | "failed"; hash?: string | null; preview?: unknown; error?: string | null }) {
